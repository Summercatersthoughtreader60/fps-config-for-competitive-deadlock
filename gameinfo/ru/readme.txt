...
👉 Отключить тени с высоких на минимум в настройках игры.                                 


\\ СВЕТ ТЕПЕРЬ НУЖНО ПРОПИСЫВАТЬ В КОНСОЛИ
r_drawskybox "false" // Включает рендер неба (skybox)
r_draw3dskybox "false" // Включает рендер 3D-неба (более детальная версия)
...
r_directlighting "1"
citadel_portrait_world_renderer_off "0" // вместо 1 на 0 

\\ ОБВОДКА не актуально но оставлю на будущее
